...
typedef enum
{
	...
	Menu_Radio3,
    Menu_ClientBuy,
    Menu_CSDM_Equip_Main,
    Menu_CSDM_Equip_Page1, // Primary
    Menu_CSDM_Equip_Page2, // Primary
    Menu_CSDM_Equip_Page3, // primary
    Menu_CSDM_Equip_Pistol, // Secondary
} _Menu;
